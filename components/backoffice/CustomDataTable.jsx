...
export default function CustomDataTable() {
    ...
    return (
        <div className='bg-slate-100 dark:bg-slate-700 p-8 rounded-lg shadow-xl mt-4'>
            <h2 className='text-xl font-bold text-slate-800 dark:text-slate-50 mb-4'>Data Table</h2>
            {/* Table */}
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between p-4" aria-label="Table navigation">
                    <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">Showing <span className="font-semibold text-gray-50 dark:text-white">{itemStartIndex}-{itemEndIndex}</span> of <span className="font-semibold text-gray-900 dark:text-white">{data.length}</span></span>
